	...
	private void fillProductType(String type) {
		...
		try {
			...
			if ("search".equals(type)) {
				...
				productType.setProductTypeName("��ѡ��....");
				productType.setId(-1);
...
ProductChosenTable.setModel(new DefaultTableModel(
	new Object [][] {
...
pack();
	...
	private void jb_putProductIntoCarActionPerformed(
		...
		try {
			...
			if (addNum == 1) {
				JOptionPane.showMessageDialog(null, "��Ʒ���빺�ﳵ�ɹ�");
				this.resetValue();
				this.fillChosenTable();

			} else {
				JOptionPane.showMessageDialog(null, "��Ʒ���빺�ﳵʧ��");
			}
		} catch (Exception e) {
			e.printStackTrace();
			JOptionPane.showMessageDialog(null, "��Ʒ���빺�ﳵʧ��");
